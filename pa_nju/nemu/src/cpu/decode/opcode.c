...
instr_func opcode_entry[256] = {
    ...
    /* 0x04 - 0x07*/ add_i2al_b, add_i2eax_v, inv, inv,
    ...
    /* 0x2c - 0x2f*/ sub_i2al_b, sub_i2eax_v, inv, inv,
    ...
    /* 0x50 - 0x53*/ push_eax_r_v, push_ecx_r_v, push_edx_r_v, push_ebx_r_v,
    /* 0x54 - 0x57*/ push_esp_r_v, push_ebp_r_v, push_esi_r_v, push_edi_r_v,
    ...
    /* 0x98 - 0x9b*/ cbw_a_v, cltd, call_far, inv,
    ...
    /* 0xc8 - 0xcb*/ inv, leave, ret_far_imm16, ret_far,
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_rm_v, call_m_v, jmp_rm_v, jmp_m_v, push_rm_v, inv};
